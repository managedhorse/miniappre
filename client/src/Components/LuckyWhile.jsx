...
const wheelSlices = [
  { option: "Lose", multiplier: 0, style: { backgroundColor: "#D30000", textColor: "#ffffff" } },
  { option: "Lose", multiplier: 0, style: { backgroundColor: "#D30000" } },
  { option: "1.2×", multiplier: 1.2, style: { backgroundColor: "#004225" } },
  { option: "1.2×", multiplier: 1.2, style: { backgroundColor: "#004225" } },
  { option: "1.2×", multiplier: 1.2, style: { backgroundColor: "#004225" } },
  { option: "1.5×", multiplier: 1.5, style: { backgroundColor: "#FFA500" } },
  { option: "3×",   multiplier: 3,   style: { backgroundColor: "#1E90FF" } },
  { option: "10×",  multiplier: 10,  style: { backgroundColor: "#800080" } },
];
      ...
      <div className="w-full max-w-md mx-auto p-4 text-white">
        ...
        {floatingText && (
          <div className="absolute top-1/2 left-1/2
                          ...
                          pointer-events-none">
            <div className="bg-black bg-opacity-70 text-white px-2 py-1
